...
addForm.addEventListener("submit", event => {
    ...
    if (value.length) { // Si el valor no está vacío
        tasks.innerHTML += `<li>
...
tasks.addEventListener("click", event => {
    if (event.target.classList.contains("delete")) { // Si se hace clic en el icono de eliminar
...
searchForm.addEventListener("click", event => {
    if (event.target.classList.contains("reset")) { // Si se hace clic en el icono de resetear
